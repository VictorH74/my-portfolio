...
export default function AdminProjectCard(props: ProjectType) {
    ...
    return (
        <>
            <div
                className="relative w-[300px] h-96 shadow-lg bg-gray-200 dark:bg-[#3f3f3f] shrink-0 grow-0 rounded-md flex flex-col overflow-hidden select-none"
            ...
            >
                ...
                <div className="w-[300px] h-[310px] overflow-hidden flex flex-nowrap text-center relative">
                    <Image
                        ...
                        className="rounded-b-md size-full object-cover"
                        alt="project screenshot"
                    />
                    {props.screenshots.length > 1 && (
                        <div
                            className="absolute right-3 bottom-3 rounded-full p-[6px] shadow-md"
