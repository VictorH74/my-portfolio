...
export const MobileViewer = (props: MobileViewerProps) => {
  return (
   <div className={twMerge("w-[30%]  rounded-4xl relative  aspect-[9/19]  slide-container bg-secondary-black p-4 shadow-[0px_0_0.625rem_#ffffffaa_inset]", props.className)}>
