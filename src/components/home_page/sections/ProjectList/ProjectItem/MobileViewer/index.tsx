...
export const MobileViewer = (props: MobileViewerProps) => {
  return (
   <div className={twMerge("h-[75%]  rounded-4xl relative  aspect-[9/20]  slide-container bg-secondary-black p-4 shadow-[0px_0_0.625rem_#ffffffaa_inset]", props.className)}>
     <div className={twMerge("rounded-3xl relative size-full bg-[#E8E8E8]", props.screenClassName)}>
