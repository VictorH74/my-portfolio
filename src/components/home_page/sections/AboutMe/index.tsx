            ...
            <div className="max-lg:px-4 max-w-default">
                <div className="flex max-lg:flex-col gap-7 justify-center items-center min-lg:mx-6">
                    <div className="max-lg:w-full min-lg:pb-3 min-lg:pr-3 size-fit relative">
                        <div 
                        className="max-lg:hidden w-[23.75rem] aspect-[2/3] rounded-2xl z-0 translate-3 bg-linear-[115deg,#00FC69_17%,#4EFFFF_70%,#2382FF_100%] brightness-90" data-aos="fade-right"
                        data-aos-duration="800"
                        data-aos-once="true"
                         />

                        <div className="absolute -top-[1.6px] -left-[1.6px] max-lg:relative" data-aos="fade-right" data-aos-delay={300} data-aos-duration="500" data-aos-once="true">
                            <ProfileImage />
                        </div>
                    </div>
                    <div className="overflow-auto w-fit text-dark-font font-medium">
                        <h2 data-aos="fade-down" className="text-4xl" data-aos-delay={200} data-aos-duration="800" data-aos-once="true">Victor H. Leal</h2>
                        <div className={twMerge('space-y-2 mt-3')} data-aos="zoom-in" data-aos-delay={400} data-aos-duration="500" data-aos-once="true">
                            <p
